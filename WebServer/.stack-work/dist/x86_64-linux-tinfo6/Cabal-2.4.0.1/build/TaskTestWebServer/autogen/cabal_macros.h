...
/* package TaskTestWebServer-0.1.0.0 */
#ifndef VERSION_TaskTestWebServer
#define VERSION_TaskTestWebServer "0.1.0.0"
#endif /* VERSION_TaskTestWebServer */
#ifndef MIN_VERSION_TaskTestWebServer
#define MIN_VERSION_TaskTestWebServer(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_TaskTestWebServer */
...
#define CURRENT_COMPONENT_ID "TaskTestWebServer-0.1.0.0-A4cgwDsuhLA8z1X7BnAb1M-TaskTestWebServer"
